...
ttHVars::ttHVars(bool makeHistos){
  ...
  */
  ...
  _boolVars["mu2_mediumID"] = 999.;
  _boolVars["mu2_isfakeablesel"] = 999.;
  _boolVars["mu2_ismvasel"] = 999.;
  ...
  _boolVars["ele2_isfakeablesel"] = 999.;
  _boolVars["ele2_ismvasel"] = 999.;
  _boolVars["ele2_isChargeConsistent"] = 999.;
  _boolVars["ele2_passesConversionVeto"] = 999.;
  _intVars["ls"] = 999.;
  _intVars["run"] = 999.;
...
void ttHVars::Clear(){
    ...
    ele1_isChargeConsistent = 0;
    ele1_passesConversionVeto = 0;
    ele2_isfakeablesel = 0;
    ele2_ismvasel = 0;
    ele2_isChargeConsistent = 0;
    ele2_passesConversionVeto = 0;
    ls = -9999;
    run = -9999;
    n_presel_mu = -9999;
...
void ttHVars::FillBranches(EventContainer * evtObj){
  ...
  _boolVars["mu2_mediumID"] = mu2_mediumID;
  _boolVars["mu2_isfakeablesel"] = mu2_isfakeablesel;
  _boolVars["mu2_ismvasel"] = mu2_ismvasel;
  ...
  _boolVars["ele2_isfakeablesel"] = ele2_isfakeablesel;
  _boolVars["ele2_ismvasel"] = ele2_ismvasel;
  _boolVars["ele2_isChargeConsistent"] = ele2_isChargeConsistent;
  _boolVars["ele2_passesConversionVeto"] = ele2_passesConversionVeto;
  _intVars["ls"] = ls;
  _intVars["run"] = run;
