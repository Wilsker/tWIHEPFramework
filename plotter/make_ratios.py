...
"gen_bjet1_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_bjet1_pt"},
"gen_bjet2_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_bjet2_pt"},
"gen_jet1_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_jet1_pt"},
"gen_jet2_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_jet2_pt"},
"gen_jet3_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_jet3_pt"},
"gen_jet4_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_jet4_pt"},
"gen_lepton1_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_lepton1_pt"},
"gen_lepton2_pt":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"gen_lepton2_pt"},
"n_gen_bjets":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"n_gen_bjets"},
"n_gen_jets":{"nbin":10,"min":0.5,"max":5.5,"cut":"EventWeight*(n_presel_jet>=4)","xlabel":"n_gen_jets"},
