 ...
 *                                                                            *
 * History                                                                    *
 *      11 Dec 2017 - Created by B. Li based on CutLeptonPt2 by P. Ryan       *
 *****************************************************************************/

#ifndef CutLeptonPt2_h
#define CutLeptonPt2_h
...
class CutLeptonPt2 : public HistoCut 
{

public:

  // Parameterized Constructor
  CutLeptonPt2(EventContainer *EventContainerObj, TString leptonType);
  
  // Destructor
  ~CutLeptonPt2();

  // Get the name of describing the cut
  inline std::string GetCutName() { return "CutLeptonPt2"; };
